        ...
        <div class="container">
            ...
            <form method="POST" action="FrontControllerServlet">
                <div class="form-group">
                    <label>Codigo aeronave: ${aeronave.codigo}</label>
                    <input class="form-control" type="hidden" name="codigo_aero" value="${aeronave.codigo}">
                </div>
                <div class="form-group">
                    <label>Modelo</label>
                    <input class="form-control" type="text" name="modelo_aero" value="${aeronave.modelo}" placeholder="Modelo da aeronave">
                </div>
                <div class="form-group">
                    <label>Capacidade</label>
                    <input class="form-control" type="text" name="capacidade_aero" value="${aeronave.capacidade}" placeholder="Capacidade da aeronave">
                </div>
