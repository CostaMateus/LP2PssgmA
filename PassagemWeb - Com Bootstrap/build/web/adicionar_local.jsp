...
<html lang="pt-br">
    ...
    <body>
        <div class="container">
            <h1 class="text-center">Adicionar novo local:</h1>
            <form method="POST" action="FrontControllerServlet">
                ...
                <div class="form-group">
                    <label>UF</label>
                    <input class="form-control" type="text" name="uf" placeholder="Sigla UF">
                </div>
            ...
            <p class="text-center">
                <a class="btn btn-default" href="FrontControllerServlet?controller=localListar">Voltar para lista de locais</a>
            </p>
        </div>
